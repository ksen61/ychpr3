...
namespace practica1.PetShopDataSetTableAdapters {
    ...
    public partial class CategoriesTableAdapter : global::System.ComponentModel.Component {
        ...
        public virtual int UpdateQueryy(string CategoryName, int Original_CategoryID) {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "DELETE FROM [dbo].[Products] WHERE (([ProductID] = @Original_ProductID) AND ([Pro" +
                "ductName] = @Original_ProductName) AND ([CategoryID]  = @Original_CategoryID) AN" +
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_ProductName", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "ProductName", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_CategoryID", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "CategoryID", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = @"select [Products].[ProductID],  [Products].[ProductName], [Products].[CategoryID], [Products].[Price], [Categories].[CategoryID], [Categories].[CategoryName], [Warehouse].[WarehouseID], [Warehouse].[ProductID], [Warehouse].[Quantity]
from [Products] inner join [Categories] on [Products].[CategoryID] = [Categories].[CategoryID]
inner join [Warehouse] on [Products].[ProductID] = [Warehouse].[ProductID]";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "INSERT INTO [dbo].[Products] ([ProductName], [CategoryID], [Price]) VALUES (@Prod" +
            ...
            this._commandCollection[4].CommandText = @"UPDATE [dbo].[Products] SET [ProductName] = @ProductName, [CategoryID] = @CategoryID, [Price] = @Price WHERE (([ProductID] = @Original_ProductID) AND ([ProductName] =  = @Original_ProductName) AND ([CategoryID]  = @Original_CategoryID) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)));
";
        ...
        public virtual PetShopDataSet.ProductsDataTable GetDataBy3() {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, false)]
        public virtual int DeleteQuery(int Original_ProductID, string Original_ProductName, global::System.Nullable<int> Original_CategoryID, global::System.Nullable<decimal> Original_Price) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            ...
            if ((Original_CategoryID.HasValue == true)) {
                command.Parameters[2].Value = ((int)(Original_CategoryID.Value));
            }
            else {
                command.Parameters[2].Value = global::System.DBNull.Value;
            }
            if ((Original_Price.HasValue == true)) {
                command.Parameters[3].Value = ((decimal)(Original_Price.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, false)]
        public virtual int UpdateQueryr() {
        ...
        internal void InsertQuery(string text, TextBox txtCategoryId, TextBox txtPrice)
        {
...
SELECT WarehouseID, ProductID, Quantity FROM Warehouse WHERE (WarehouseID = @WarehouseID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "DELETE FROM Warehouse WHERE (([WarehouseID] = @Original_WarehouseID) AND ((@IsNul" +
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_ProductID", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "ProductID", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_Quantity", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Quantity", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
            ...
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "INSERT INTO [dbo].[Warehouse] ([ProductID], [Quantity]) VALUES (@ProductID, @Quan" +
                "tity);\r\n";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = @"UPDATE Warehouse SET ProductID = @ProductID, Quantity = @Quantity WHERE ((WarehouseID = @Original_WarehouseID) AND ((@IsNull_ProductID = 1 AND ProductID IS NULL) OR (ProductID = @Original_ProductID)) AND ((@IsNull_Quantity = 1 AND Quantity IS NULL) OR (Quantity = @Original_Quantity)));
";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_ProductID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ProductID", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_Quantity", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Quantity", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, false)]
        public virtual int DeleteQuery(int Original_WarehouseID, global::System.Nullable<int> IsNull_ProductID, global::System.Nullable<int> Original_ProductID, global::System.Nullable<int> IsNull_Quantity, global::System.Nullable<int> Original_Quantity) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            command.Parameters[0].Value = ((int)(Original_WarehouseID));
            if ((IsNull_ProductID.HasValue == true)) {
                command.Parameters[1].Value = ((int)(IsNull_ProductID.Value));
            }
            else {
                command.Parameters[1].Value = global::System.DBNull.Value;
            }
            if ((Original_ProductID.HasValue == true)) {
                command.Parameters[2].Value = ((int)(Original_ProductID.Value));
            }
            else {
                command.Parameters[2].Value = global::System.DBNull.Value;
            }
            if ((IsNull_Quantity.HasValue == true)) {
                command.Parameters[3].Value = ((int)(IsNull_Quantity.Value));
            }
            else {
                command.Parameters[3].Value = global::System.DBNull.Value;
            }
            if ((Original_Quantity.HasValue == true)) {
                command.Parameters[4].Value = ((int)(Original_Quantity.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, false)]
        public virtual int UpdateQuery1(global::System.Nullable<int> ProductID, global::System.Nullable<int> Quantity, int Original_WarehouseID, global::System.Nullable<int> IsNull_ProductID, global::System.Nullable<int> IsNull_Quantity, global::System.Nullable<int> Original_ProductID) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[3];
            if ((ProductID.HasValue == true)) {
                command.Parameters[0].Value = ((int)(ProductID.Value));
            }
            ...
            if ((IsNull_Quantity.HasValue == true)) {
                command.Parameters[4].Value = ((int)(IsNull_Quantity.Value));
            }
            else {
                command.Parameters[4].Value = global::System.DBNull.Value;
            }
            if ((Original_ProductID.HasValue == true)) {
                command.Parameters[5].Value = ((int)(Original_ProductID.Value));
            }
            else {
        ...
        internal void InsertQuery(string text1, string text2)
        {
            throw new NotImplementedException();
        }

        internal void DeleteQuery(int productId)
        {
            throw new NotImplementedException();
        }
    }
